...
use objc2_app_kit::{
    NSImage, NSMenu, NSMenuDelegate, NSMenuItem, NSStatusBar, NSStatusItem, NSWindow,
    NSWindowStyleMask, NSBackingStoreType, NSTextField, NSImageView, NSImageScaling,
    NSButton,
};
use objc2_foundation::{MainThreadMarker, NSObject, NSObjectProtocol, NSString, ns_string, NSRect, NSPoint, NSSize, NSURL};
...
/// Handler function for opening the GitHub URL
fn open_github_url_handler() {
    use log::info;
